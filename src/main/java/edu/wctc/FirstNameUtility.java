...
public class FirstNameUtility {
    ...
    public int encodeFirstName(String firstName, String middleInitial) throws MissingNameException {
        ...
        int firstSumHolder = 0;
        int middleSumHolder = 0;
        ...
        else
        {
            ...
            if(firstNameCodeMap.containsKey(firstName))
            {
                ...
                firstSumHolder = firstNameCodeMap.get(firstName);
                middleSumHolder = middleInitialCodeMap.get(middleInitial);

            }
            else
            {

               char[] firstNameAsChars = firstName.toCharArray();

               firstSumHolder = firstInitialCodeMap.get(firstNameAsChars[0]);
            ...
            return firstSumHolder + middleSumHolder;
